  ...
  <aside id="sidebar" class="fixed inset-y-0 left-0 z-40 w-64 bg-white shadow-xl transform -translate-x-full md:translate-x-0 transition-transform duration-300">
    <div class="flex flex-col h-full">
      <div class="p-6 mb-4">
        ...
        <p class="text-sm text-gray-500 mt-1">Manager Dashboard</p>
      </div>

      <nav class="flex-1 px-3 space-y-1">
        @foreach([
          ['route' => 'manager.index', 'icon' => 'table-columns', 'label' => 'Dashboard'],
          ['route' => 'manager.transaksi.index', 'icon' => 'money-bill-wave', 'label' => 'Transaksi']
        ] as $item)
